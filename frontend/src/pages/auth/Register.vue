<template>
    <AuthLayout>
        <template v-slot:auth>
            <div
                class="container mx-auto flex flex-col bg-white shadow-md px-4 sm:px-6 md:px-8 lg:px-10 py-8 rounded-md w-full max-w-md">
                <div class="font-medium self-center text-xl sm:text-2xl uppercase text-gray-800">Create New Account
                </div>
                    ...
                    <form @submit.prevent="hendleSubmit">
                        ...
                        <div class="flex w-full">
                            <button type="submit"
                                ...
                                <span class="mr-2 uppercase">Regiter</span>
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="flex justify-center items-center mt-6">
                    <a href="#" target="_blank"
                        ...
                        <router-link to="/login" class="ml-2">Back To Login Page</router-link>
                    </a>
                </div>
            </div>
        </template>
